...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy-deep">
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-t from-navy-deep via-transparent to-navy-deep/70"
        aria-hidden
      />
      ...
      <Container className="relative">
        <div className="flex min-h-[92svh] flex-col pb-12 pt-32 sm:pt-36">
          ...
          <Reveal delay={0.3}>
            <div className="mt-12 grid grid-cols-2 gap-y-8 rounded-xl border border-white/10 bg-white/[0.04] p-7 backdrop-blur-sm sm:grid-cols-4 sm:divide-x sm:divide-white/10">
              {site.stats.map((s) => (
